...
namespace Steam4NET
{
	...
	public class ISteamRemoteStorage010 : InteropHelp.NativeWrapper<ISteamRemoteStorage010VTable>
	{
		...
		{
			return InteropHelp.DecodeANSIReturn( this.GetFunction<NativeGetFileNameAndSizeII>( this.Functions.GetFileNameAndSize16 )( this.ObjectAddress, iFile, ref pnFileSizeInBytes ) ); 
		}
